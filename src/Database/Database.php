...
class Database
{
    ...
    private $dbUsername = "id20198149_root"; // Change this to your Db Username;
    private $dbPassword = "W=2mfLHo#F94u^]+"; // Change this to your password;
    private $dbName = "id20198149_scandiweb"; // Cahnge this to your Db name;
